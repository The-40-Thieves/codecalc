...
> [!NOTE]
> Published as **`codecalc` 0.6.0** on PyPI (`pip install codecalc`) and the
> **`codecalc-exec` 0.6.0** executor on crates.io
...
58 test files and 16 CI-invoked scripts, **2184 assertions**. "CI-invoked"
